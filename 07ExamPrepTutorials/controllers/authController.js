...
body('username')
    .isLength({min:5}).withMessage('Username should be at least 5 characters long!')
...
authController.post('/login',body('username')
.isLength({min:5}).withMessage('Username should be at least 5 characters long!')
.isAlphanumeric().withMessage('Password: Only latin letters and numbers allowed!'),
body('password')
.isLength({min:5}).withMessage('Invalid password must be at least 5 characters long!')
.isAlphanumeric().withMessage('Password: Only latin letters and numbers allowed!'),async (req,res)=>{
